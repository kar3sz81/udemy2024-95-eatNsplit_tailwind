...
function App() {
  ...
  return (
    ...
    <div className='grid grid-cols-2 gap-4 m-4'>
      <div className='min-h-[100px] bg-pink-100 shadow-2xl rounded-2xl'>
        ...
        <div>
          ...
          <div className='grid h-[244px] bg-pink-100 shadow-2xl rounded-2xl gap-4 text-2x'>
      ...
      <div>
        <button type='button' className='float-right mr-5 bg-blue-300 hover:bg-blue-500 text-blue-950 font-bold rounded w-[153px] mt-8'>Close</button>
